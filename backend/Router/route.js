...
/**
 * ########### The "controller.verifyusers" is not neccessirily attached during backend api test
 */
/**GET ROUTE */
...
router.route('/verifyOTP').get(controller.verifyusers, controller.verifyOTP); // Verify one time password
...
router.route('/authenticate').post(controller.verifyusers, (req, res)=>{
    res.end();
}); // Authenticate user
